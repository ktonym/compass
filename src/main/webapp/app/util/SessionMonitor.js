 ...
 * logged out.
 */
Ext.define('compass.util.SessionMonitor', {
    singleton: true,
    ...
    window: Ext.create('Ext.window.Window', {
        ...
        buttons: [{
            ...
            handler: function() {
                Ext.TaskManager.stop(compass.util.SessionMonitor.countDownTask);
                compass.util.SessionMonitor.window.hide();
                compass.util.SessionMonitor.start();
                // 'poke' the server-side to update your session.
                Ext.Ajax.request({
                    url: 'compass/security/user/poke.action'
                });
            }
        },{
            text: 'Logout',
